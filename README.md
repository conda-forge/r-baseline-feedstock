...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-baseline-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-baseline-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-baseline-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-baseline-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-baseline-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-baseline-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-baseline/badges/version.svg)](https://anaconda.org/conda-forge/r-baseline)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-baseline/badges/downloads.svg)](https://anaconda.org/conda-forge/r-baseline)
